...
返回严格JSON格式，不要输出任何多余文字：
{
  ...
  "overallComment": "总体评价（600-1000字）：按照以下结构组织：\n\n【主要问题与错误】（放在最前面，200-300字）：详细分析学生犯了哪些关键错误，包括诊断错误、检查遗漏、用药不当、问诊不足、手术问题等。每个错误要具体说明学生做了什么、正确的做法是什么、为什么这样做有问题。\n\n【优点与亮点】（100-200字）：肯定学生做得好的方面，如诊断思路正确、检查合理、问诊全面、用药恰当等。\n\n【不足与改进】（200-300字）：分析学生在哪些方面存在不足，具体说明需要改进的地方，给出详细的学习建议和改进方向。\n\n【总结】（100-150字）：给出整体评价和鼓励，帮助学生明确努力方向。\n\n内容要专业、详细、有建设性，字数必须在600-1000字。",
  "matchType": "exact/partial/keyword/wrong",
  "diagnosisMatch": true或false
}

注意：
- overallComment 必须在600-1000字左右，按照【主要问题与错误】【优点与亮点】【不足与改进】【总结】四个部分组织，内容要专业详细有建设性
